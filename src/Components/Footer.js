...
const Footer = () => {
  ...
  const handleGithub = (e) =>{
    window.open("https://github.com/nitinmmmut/typing-speed", '_blank');
  }

  const handleLinkedin = () =>{
    window.open("https://www.linkedin.com/in/nitin-verma-02357a119/", '_blank');
  }
  ...
  const handleDocs = () =>{
    window.open("https://docs.google.com/document/d/1kWHzUTc7QdiQ-41DRlASh7uaL87O8KiJV7Gu0kkcvDs/edit", '_blank');
  }
